...
Combina Django con ECharts: aprende a utilizar la librería Apache ECharts para crear gráficos dinámicos y mostrar datos leídos desde una aplicación backend (API) creada con Python y Django. Cónoce cómo utilizar el framework web Django para proveer datos que se mostrarán en un gráficos dinámico (usando el plugin Apache ECharts).
